...
import ImageFullCenter from './ImageFullCenter'
...

{
                        ...
                        {/* <ImageFullCenter width={300} address={housePhoto[1]}  src={housePhoto[1]} fallback={fallback} /> */}
                        {/* <ImageFullCenter width={300} address={housePhoto[1]} fallback={fallback} /> */}
                        <ImageFullCenter size={300}  src={housePhoto[1]} fallback={fallback} />
                         </div>
                        ):null                  
                    }
