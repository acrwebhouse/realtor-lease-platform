...
const HouseImage = (prop) => {
    ...
    useEffect(() => {
        // //concole.log('===000==0000')
        // const img = document.getElementById('img');
        // let width = img.clientWidth
        // let height = img.clientHeight
        // //concole.log('===000==111= prop',prop)
        // //concole.log('===000==222= prop',width,height)
        // if(init && width > 0 && height > 0){
        // //concole.log(width,height)
        // //concole.log('===000=== prop',prop)
        // if(width <= height){
        //     //concole.log('===111=== prop',prop)
        //     setImageHeight(null)
    ...
    return (
        <div style={{width:prop.size+'px',height:prop.size+'px',position: 'relative',overflow:'hidden' ,backgroundColor : '#ff0000'} }>
             <Image id='img' width={prop.size} src={prop.image} fallback={fallback} />    
        </div>
    );
};
