...
const sortOptions = [{ value: '時間近到遠' }, { value: '時間遠到近' }, { value: '第幾筆開始' }, { value: '總筆數數量' }, { value: '狀態數量' }];
const reserveStateArr = ['未接洽', '接洽中', '完成看房']
console.log(sortOptions[3].value)
    ...
    const changeSort = (sort) => {
        ...
        switch(sort){
            ...
            case sortOptions[3].value:
                setShowStartOrCountOrState(2);
                break;
            case sortOptions[4].value:
                setShowStartOrCountOrState(3);
                break;
            default:
                getHousesArg.timeSort = '-1';
                setShowStartOrCountOrState(0);
                        ...
                        {showStartOrCountOrState !== 0 ?
                            showStartOrCountOrState === 1 ?
                                ...
                                showStartOrCountOrState === 2 ?
                                    ...
                                    :
                                    <Input id="stateNo"  allowClear onChange={(e) => getHousesArg.state=e.target.value} placeholder="選狀態（填數字）"  style={{
                                        width: '100%',
                                        height: '40px',
                                    }}>
                                    </Input>
